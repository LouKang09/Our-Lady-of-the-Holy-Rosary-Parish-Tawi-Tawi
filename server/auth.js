...
export async function requireAdmin(request,env){
 if(env.AUTH_MODE==='password'){const a=env.AUTH_ACCOUNT;if(!a||!['owner','staff'].includes(a.access_role))throw new HttpError(401,'Please sign in to manage the parish website.');return {userId:a.id,email:a.email,name:a.name,role:a.access_role,committee:a.committee};}
